 ...
 * @author dale
 */
public class DocumentUIController implements Initializable {
    ...
    private void handleOpen(ActionEvent event) {
        ...
        if (file != null) {
            try
            {
                ...
                SaxParser sax = new SaxParser(file);
                sax.parseXml();  
                textArea.setText(sax.output);
                //SaxParser saxParser = new SaxParser(file);
                //saxParser.parseXml();   
